...
{"time":"2026-01-31T20:00:30Z","level":"ERROR","msg":"API error","request.id":"8d0e7780-8536-51ef-a55c-f18fd2f91bf8","request.method":"GET","request.path":"/gates/invalid-id","error.type":"/errors/not-found","error.title":"Gate Not Found","error.status":404}
```
